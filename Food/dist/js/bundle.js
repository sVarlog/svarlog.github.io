...
/***/ "./production/js/modules/slider.min.js":
/*!*********************************************!*\
  !*** ./production/js/modules/slider.min.js ***!
  \*********************************************/
/*! namespace exports */
/*! export initCustomSlider [provided] [no usage info] [missing usage info prevents renaming] */
...
/* harmony export */   "initCustomSlider": function() { return /* binding */ initCustomSlider; }
/* harmony export */ });
...
var initCustomSlider = function initCustomSlider(_ref) {
  ...
  try {
    ...
    if (dots == true) {
      ...
      if (sliderItems.length < 10) {
        total.innerHTML = "0".concat(sliderItems.length);
      } else {
    ...
    var events = function events() {
      var changeSlideNum = function changeSlideNum(num) {
        if (sliderItems.length < 10) {
          num = "0".concat(num += 1);
        }
...
/* harmony import */ var _modules_slider_min_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/slider.min.js */ "./production/js/modules/slider.min.js");
...
var slider = function slider() {
  (0,_modules_slider_min_js__WEBPACK_IMPORTED_MODULE_17__.initCustomSlider)({
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./production/js/script.js");
