...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn', 1);
  Object(_modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical', '', '', 1);
  Object(_modules_forms_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_mask_js__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_checkTextInputs_js__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextInputs_js__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_showMoreStyles_js__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
  ...
  Object(_modules_burger_js__WEBPACK_IMPORTED_MODULE_10__["default"])('.burger-menu', '.burger');
  Object(_modules_scrolling_js__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup');
  Object(_modules_drop_js__WEBPACK_IMPORTED_MODULE_12__["default"])();
});
...
var accordion = function accordion(triggersSelector) {
  ...
  btns.forEach(function (el) {
    el.addEventListener('click', function () {
      el.classList.toggle('active-style');
      el.nextElementSibling.classList.toggle('active-content');

      if (el.classList.contains('active-style')) {
        el.nextElementSibling.style.maxHeight = "".concat(el.nextElementSibling.scrollHeight + 80, "px");
      } else {
...
var checkTextInputs = function checkTextInputs(selector) {
  ...
  txtInputs.forEach(function (el) {
    el.addEventListener('input', function (e) {
      el.value = el.value.replace(/[^а-яё 0-9]/ig, '');
    });
  });
};
...
var drop = function drop() {
  ...
  var highLight = function highLight(item) {
    item.closest('.file_upload').style.border = '2px solid green';
    item.closest('.file_upload').style.backgroundColor = 'rgba(0,0,0,.7)';
  };

  var unhighLight = function unhighLight(item) {
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType) {
    items.markAll.forEach(function (el) {
  ...
  var _loop = function _loop(btn) {
    buttons[btn].dataset.btnNum = i;
    buttons[btn].addEventListener('click', function () {
      if (items[Object.keys(items)[buttons[btn].dataset.btnNum]]) {
        typeFilter(items[Object.keys(items)[buttons[btn].dataset.btnNum]]);
      } else {
        typeFilter();
      }
    });
...
/* harmony import */ var _services_requests_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/requests.js */ "./src/js/services/requests.js");
...
var forms = function forms() {
  ...
  form.forEach(function (el) {
    el.addEventListener('submit', function (e) {
      ...
      console.log(api);
      Object(_services_requests_js__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        console.log(res);
...
var mask = function mask(selector) {
  ...
  var createMask = function createMask(event) {
...
var modals = function modals() {
  ...
  var bindModal = function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var type = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  ...
  var showModalByTime = function showModalByTime(trigger, selector, close, time) {
    setTimeout(function () {
      var display;
      ...
      if (!display) {
        bindModal(trigger, selector, close, false, true);
      }
    }, time);
  };
  ...
  showModalByTime('.button-consultation', '.popup-consultation', '.popup-consultation .popup-close', 5000);
};
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  var showImg = function showImg(block) {
    ...
    block.querySelectorAll('p:not(.sizes-hit)').forEach(function (el) {
      el.style.display = 'none';
    });
  };
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    ...
    Object(_services_requests_js__WEBPACK_IMPORTED_MODULE_6__["getResource"])('assets/db.json').then(function (res) {
  ...
  var createCards = function createCards(response) {
...
var sliders = function sliders(slides, dir, prev, next, slide) {
  ...
  var changeSlides = function changeSlides(n) {
