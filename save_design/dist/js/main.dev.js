...
$(document).ready(function () {
  ...
  function checkStep(step) {
    var lines = document.querySelectorAll(".loan .line");
  ...
  function p(t, e) {
    ...
    $.each($(".__fix-block"), function (t, e) {
      ...
      n.outerHeight() < s - (i + 30) ? (scr > l.offset().top - (i + 15) ? n.css({
        ...
        width: l.outerWidth(),
        left: l.offset().left
      }) : a(n), scr > l.outerHeight() + l.offset().top - (n.outerHeight() + (i + 15)) && (l.css({
        position: "relative"
      }), n.css({
        position: "absolute",
        top: "auto",
  ...
  if (n() && $("body").addClass("ie"), l.any() && $("body").addClass("touch"), function () {
    if ($("select").length > 0 && !$("select").hasClass('custom')) {
      ...
      _t(), $("body").on("keyup", "input.select-title__value", function () {
    ...
    }), $("body").off("click", ".check", function (t) {}), $("body").on("click", ".check", function (t) {
    ...
    if (e.length > 0) {
      ...
      for (var _i = 0; _i < e.length; _i++) {
        var _a = e[_i],
            _o = _a.getAttribute("data-da");

        if ("" != _o) {
          var _e = _o.split(","),
              _i2 = _e[1] ? _e[1].trim() : "last",
              _c = _e[2] ? _e[2].trim() : "767",
              _d = "min" === _e[3] ? _e[3].trim() : "max",
              _h = document.querySelector("." + _e[0].trim());

          _e.length > 0 && _h && (_a.setAttribute("data-da-index", _r), t[_r] = {
            parent: _a.parentNode,
            index: (l = _a, n = void 0, n = Array.prototype.slice.call(l.parentNode.children), n.indexOf(l))
          }, s[_r] = {
            element: _a,
            destination: document.querySelector("." + _e[0].trim()),
            place: _i2,
            breakpoint: _c,
            type: _d
          }, _r++);
      ...
      for (var _t2 = 0; _t2 < s.length; _t2++) {
        var _e2 = s[_t2],
            _a2 = _e2.breakpoint,
            _l = _e2.type;
        i.push(window.matchMedia("(" + _l + "-width: " + _a2 + "px)")), i[_t2].addListener(o);
      }
    }
    ...
    function o(t) {
      for (var _t3 = 0; _t3 < s.length; _t3++) {
        var _e3 = s[_t3],
            _a3 = _e3.element,
            _l2 = _e3.destination,
            _n = _e3.place,
            _o2 = "_dynamic_adapt_" + _e3.breakpoint;

        if (i[_t3].matches) {
          if (!_a3.classList.contains(_o2)) {
            var _t4 = c(_l2)[_n];

            "first" === _n ? _t4 = c(_l2)[0] : "last" === _n && (_t4 = c(_l2)[c(_l2).length]), _l2.insertBefore(_a3, _l2.children[_t4]), _a3.classList.add(_o2);
          }
        } else _a3.classList.contains(_o2) && (r(_a3), _a3.classList.remove(_o2));
      }
    }

    function r(e) {
      var s = e.getAttribute("data-da-index"),
          i = t[s],
          a = i.parent,
          l = i.index,
          n = c(a, !0)[l];
    ...
    function c(t, e) {
      ...
      for (var _t5 = 0; _t5 < s.length; _t5++) {
        var _a4 = s[_t5];
        (e || null == _a4.getAttribute("data-da")) && i.push(_t5);
      }
    ...
    var e = $(this).index() + 1;
    $("body,html").animate({
      scrollTop: $(".sector-" + e).offset().top + 0
    }, 800, function () {});
  ...
  }), t = jQuery, e = function e(t) {
    return t.split("").reverse().join("");
  }, s = {
    numberStep: function numberStep(e, s) {
      var i = Math.floor(e);
      t(s.elem).text(i);
    }
  }, i = function i(t) {
    ...
    set: i
  } : t.fx.step.number = i, t.animateNumber = {
    numberStepFactories: {
    ...
    for (var e = arguments[0], i = t.extend({}, s, e), a = t(this), l = [i], n = 1, o = arguments.length; n < o; n++) {
      l.push(arguments[n]);
    }
    ...
    $(".popup-" + v).length > 0 ? _(v) : $("div." + v).length > 0 && $("body,html").animate({
      scrollTop: $("div." + v).offset().top
    }, 500, function () {});
  }

  $(".wrapper").addClass("loaded");
  if (l.iOS()) ;
  var f = document.querySelector(".icon-menu"),
  ...
  function _(t, e) {
    ...
    }).addClass("lock"), $(".pdb").css({
      paddingRight: $(window).outerWidth() - $(".wrapper").outerWidth()
    })), history.pushState("", "", "#" + t), "" != e && null != e && $(".popup-" + t + " .popup-video__value").html('<iframe src="https://www.youtube.com/embed/' + e + '?autoplay=1"  allow="autoplay; encrypted-media" allowfullscreen></iframe>'), $(".popup-" + t).fadeIn(300).delay(300).addClass("active"), $(".popup-" + t).find(".slick-slider").length > 0 && $(".popup-" + t).find(".slick-slider").slick("setPosition");
  }
  ...
  f && f.addEventListener("click", function () {
    ...
    }, 500, function () {}), $(".menu__body").hasClass("active") && ($(".menu__body,.icon-menu").removeClass("active"), $("body").removeClass("lock")), !1;
  }), function () {
    if (n()) {
      var _e4 = document.querySelectorAll(".ibg");

      for (var t = 0; t < _e4.length; t++) {
        _e4[t].querySelector("img") && null != _e4[t].querySelector("img").getAttribute("src") && (_e4[t].style.backgroundImage = "url(" + _e4[t].querySelector("img").getAttribute("src") + ")");
      }
    }
  }(), $(document).on("click touchstart", function (t) {
  ...
  var M = $("#slider"),
      B = $(".application__bar .application__fill");
  ...
  M.on("input", L), L();
  var H = $("#slider1"),
      O = $(".application__bar1 .application__fill1");
